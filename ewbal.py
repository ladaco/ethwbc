    ...
    while True:
        ...
        try:
            ...
            if "result" in r:
                btc = float(r["result"])
                #if btc == 0.0:
                 #text1 = "\nAddr0: " + str(addr) + " Bal: " + str(btc) + " ETH."
        ...
        #https://api.bscscan.com/api?module=account&action=balance&address=0x0000b07FCf8ED4F6D7E1411e2d47d8742B9Aba85&apikey=6FBCS9ED62AAAB1J6KYBB8TWSB4CFSXAK8
        #https://api.etherscan.io/api?module=account&action=balance&address=0xde0b295669a9fd93d5f28d9ec85e40f4cb697bae&tag=latest&apikey=AS1S5B6DHNJAT7T4ABIN59CYCW3RGEWJRT
        balance_url = "https://api.bscscan.com/api?module=account&action=balance&address=" + str(addr1) + "&apikey=D3WINVSR7BZ43ND47S8PCQ1KA1GNUD3WSS"
        
        r = requests.get(balance_url, headers={"x-api-key":"D3WINVSR7BZ43ND47S8PCQ1KA1GNUD3WSS"})
        ...
        try:
            ...
            if "result" in r:
                btc = float(r["result"])
                #if btc == 0.0:
                 #text1 = "\nAddr1: " + str(addr) + " Bal: " + str(btc) + " ETH."
                 #print("seed phrase: {:<90} {:<15}".format(mnemonic_words, text1))
                ...
                if btc > 0:
                    ...
                    f.write("seed phrase: " + mnemonic_words + "\t" + "Bal: " + str(btc) + " ETH.\n")
                    f.close()
                #text1 = "\nAddr1: " + str(addr1) + " Bal: " + str(btc) + " ETH."
                #print("seed phrase: {:<90} {:<15}".format(mnemonic_words, text1))
            else:
                print("Fatal error")
        except simplejson.errors.JSONDecodeError:
        ...
        #https://api.bscscan.com/api?module=account&action=balance&address=0x0000b07FCf8ED4F6D7E1411e2d47d8742B9Aba85&apikey=6FBCS9ED62AAAB1J6KYBB8TWSB4CFSXAK8
        #https://api.etherscan.io/api?module=account&action=balance&address=0xde0b295669a9fd93d5f28d9ec85e40f4cb697bae&tag=latest&apikey=AS1S5B6DHNJAT7T4ABIN59CYCW3RGEWJRT
        balance_url = "https://api.bscscan.com/api?module=account&action=balance&address=" + str(addr1) + "&apikey=BHSWCV1UG4SHE4BA9Q83CCP4T9AYBZI8IA"
        
        r = requests.get(balance_url, headers={"x-api-key":"BHSWCV1UG4SHE4BA9Q83CCP4T9AYBZI8IA"})
        ...
        try:
            ...
            if "result" in r:
                btc = float(r["result"])
                #if btc == 0.0:
                 #text1 = "\nAddr2: " + str(addr) + " Bal: " + str(btc) + " ETH."
                 #print("seed phrase: {:<90} {:<15}".format(mnemonic_words, text1))
                ...
                if btc > 0:
                    ...
                    f.write("seed phrase: " + mnemonic_words + "\t" + "Bal: " + str(btc) + " ETH.\n")
                    f.close()
                #text1 = "\nAddr2: " + str(addr1) + " Bal: " + str(btc) + " ETH."
                #print("seed phrase: {:<90} {:<15}".format(mnemonic_words, text1))
            else:
                print("Fatal error")
        except simplejson.errors.JSONDecodeError:
